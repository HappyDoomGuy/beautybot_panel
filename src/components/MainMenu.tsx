  ...
  const apps = [
    {
      ...
      description: 'Персональный план питания с расчетом КБЖУ, калькулятором веса и умными советами по диете от ИИ',
    ...
    },
    {
      ...
      title: 'Расшифровщик анализов',
      description: 'Загружай данные медицинских анализов и получай простое, понятное объяснение изменений в твоем организме',
    ...
    },
    {
      ...
      description: 'Звездный прогноз красоты подскажет, когда лучше всего сиять',
    ...
    },
    {
      ...
      title: 'Аффирмации красоты',
      description: '30-дневный заряд уверенности, который наполнит твой день позитивом и силой',
