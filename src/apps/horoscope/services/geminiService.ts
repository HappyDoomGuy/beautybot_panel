...
export const getHoroscope = async (sign: ZodiacSign): Promise<HoroscopeData> => {
  ...
  const prompt = `
    ...
    ОБЯЗАТЕЛЬНОЕ НАЧАЛО ГОРОСКОПА:
    В самом начале гороскопа обязательно укажи сегодняшнюю дату (${today}) и раскрой ее астрономическое значение и толкование для знака ${sign}. Объясни, какие планетарные влияния действуют сегодня и как это отражается на энергии дня.
